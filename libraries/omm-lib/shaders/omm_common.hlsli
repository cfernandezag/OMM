...
{
	uint3 indices;
	indices.x		= indexBuffer[g_GlobalConstants.IndexBufferOffsetInBytes + primitiveIndex * 3 + 0];
	indices.y		= indexBuffer[g_GlobalConstants.IndexBufferOffsetInBytes + primitiveIndex * 3 + 1];
	indices.z		= indexBuffer[g_GlobalConstants.IndexBufferOffsetInBytes + primitiveIndex * 3 + 2];
